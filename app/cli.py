...
def main() -> None:
    parser = argparse.ArgumentParser(prog="200iq-moments")
    ...
    mcp_http_parser = subcommands.add_parser("mcp-http", help="Start HTTP/Streamable HTTP MCP server")
    mcp_http_parser.add_argument("--host", default="127.0.0.1")
    mcp_http_parser.add_argument("--port", default=8201, type=int)
