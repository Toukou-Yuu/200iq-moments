...
def create_case(
    ...
    return {
        ...
        "index_event": {"type": "case.created", "case_id": record.id},
    }
...
def update_case(
    ...
    return {
        ...
        "index_event": {"type": "case.updated", "case_id": record.id},
    }
...
def delete_case(
    ...
    event_type = "case.deleted" if status == CaseStatus.DELETED else "case.archived"
    return {
        "case_id": record.id,
        "status": record.status.value,
        "index_event": {"type": event_type, "case_id": record.id},
    }
